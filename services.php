...
<body>
    ...
    <div class="nav">
        <img src="https://www.canva.com/design/DAFhGnC_328/7-GX05iG-rMEn1OIkbfXBw/edit" alt="">
        ...
        <div class="logo">
            ...
            <img src="images/Creative-PhotoRoom.png-PhotoRoom.png" alt="">
        ...
        <form class="search">
            <input type="text" name="search" id="search" placeholder="Search" class="search--input" class="serenity-image">
            <button type="button" class="serach--btn"    >
                <img src="images/search-bar.png" class="svg">
            </button>
        </form>
    </div>
...
<main>
    ...
    <div class="myCard">
        <p class="par">Virtual Counselling</p>
        <div class="innerCard">
            <div class="frontSide">
                <p class="title"></p>
                <img src="images/online doctor.jpg" alt="" class="immage">
            </div>
            ...
            <div class="backSide">
                <p class="title">Get the best from our trained mental health professionals at the comfort of your home</p>
  ...
  <button onclick="window.location.href='coaches.php'"  > Learn more
  </button>
  ...
  <div class="dots">
    ...
    <div class="dot dot-5"></div>
                  ...
                  <div class="myCard">
        <p class="par">Self-help tools</p>
        <div class="innerCard">
            <div class="frontSide">
                <p class="title"></p>
                <img src="images/chaservice.jpg" alt="" class="immage">
            </div>
            ...
            <div class="backSide">
                <p class="title">Take advantage of our  self-help tools to guide you on your journey to mentall wellness</p>
  ...
  <button   onclick="window.location.href='twochatbots.php'"    >Learn more
  </button>
  <svg version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 234.6 61.3" preserveAspectRatio="none" xml:space="preserve">
...
<div class="myCard">
<p class="par"   >Library Resource</p>
<div class="innerCard">
<div class="frontSide">
<p class="title"></p>
<img src="images/resourcelibrary.png" alt="" class="immage">
</div>
...
<div class="backSide">
<p class="title">  Discover our library's diverse mental health resources to support your personal growth. </p>
...
<button    onclick="window.location.href='libraryy.php'"      >Learn more
</button>
<svg version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 234.6 61.3" preserveAspectRatio="none" xml:space="preserve">
...
<a href="https://twitter.com/ThriveMentor" class="fa fa-twitter"></a>
<a href="https://www.facebook.com/profile.php?id=100093026431060"><i class="fa fa-facebook"></i></a>
        ...
        <div class="footer-right">
            <p class="footer-company-about">
                ...
                <b>ThriveMentor.io</b> is a website that is built for people in need of help and willing to be assisted dealing with their issues <br>
                &copy; 2023 ThriveMentor. All rights reserved.  <a href="terms-and-conditions.html">Terms of Service</a>
            </p>
        </div>
